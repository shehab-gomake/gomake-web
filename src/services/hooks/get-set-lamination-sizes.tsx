...
const getAndSetLaminationSuppliers = async (
  callApi: ICallApi,
  setState?: ISetState,
  data?: any
) => {
  const result: any = await callApi(
    "GET",
    "/v1/lamination/get-supplier-by-category",
    data
  );
  return returnResult(result, undefined);
};

const getAndSetAllLaminationSizes = async (
  callApi: ICallApi,
  setState?: ISetState,
  data?: any
) => {
...
export {
  ...
  getAndSetLaminationSuppliers,
  getAndSetAllLaminationSizes,
};
