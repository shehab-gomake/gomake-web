...
const getAndSetSheetEncapsulationSuppliers = async (
  callApi: ICallApi,
  setState?: ISetState,
  data?: any
) => {
  const result: any = await callApi(
    "GET",
    "/v1/sheet-encapsulation/get-supplier-by-category",
    data
  );
  return returnResult(result, undefined);
};

const getAndSetAllSheetEncapsulationSizes = async (
  callApi: ICallApi,
  setState?: ISetState,
  data?: any
) => {
  if (data?.categoryName) {
    const result: any = await callApi(
      "GET",
      "/v1/sheet-encapsulation/get-all-sizes",
      data
    );
    const _data = returnResult(result, undefined);
...
export {
  ...
  getAndSetSheetEncapsulationSuppliers,
  getAndSetAllSheetEncapsulationSizes,
};
