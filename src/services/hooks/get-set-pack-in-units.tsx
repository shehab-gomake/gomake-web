...
const getAndSetPackinUnitsSuppliers = async (
  callApi: ICallApi,
  setState?: ISetState,
  data?: any
) => {
  const result: any = await callApi(
    "GET",
    "/v1/packin-units/get-supplier-by-category",
    data
  );
  return returnResult(result, undefined);
};
const getAndSetAllPackinUnitsSizes = async (
  callApi: ICallApi,
  setState?: ISetState,
  data?: any
) => {
