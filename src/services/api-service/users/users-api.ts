...
const TOGGLE_USER_FIRST_LOGIN_URL = '/v1/crm-service/users/toggle-first-login';
...
const toggleUserFirstLogin: ICallAndSetData = async (callApi, setState) => {
    return await getSetApiData(callApi, EHttpMethod.PUT, TOGGLE_USER_FIRST_LOGIN_URL, setState);
}


export {getAllUsersApi, getEmployeeApi, toggleEmployeeStatus, addNewEmployee, updateEmployee, toggleUserFirstLogin};