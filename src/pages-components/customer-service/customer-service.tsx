...
const CustomerServicePageWidget = () => {
    ...
    return (
        <div style={clasess.mainContainer}>
            ...
            />
            <GomakePrimaryButton style={clasess.btnContainer} onClick={onClickOpenModal} >Add New Ticket</GomakePrimaryButton>
            <GoMakeModal
            ...
            >
                <div style={clasess.mainModalContainer}>
                    ...
                    />
                    <GomakePrimaryButton style={clasess.btnContainer}>Add Ticket</GomakePrimaryButton>
                </div>
            </GoMakeModal>
        </div>
