    ...
    return (
        <Row style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: "16px", marginTop: "24px" }} >
            <Col style={{ display: "flex", width: '180px', flexDirection: "column", alignItems: "flex-start", gap: "10px" }}>
                ...
                <input style={clasess.inputStyle} placeholder="placeholder" type="text" value={user?.username} onChange={(e) => setUser({ ...user, username: e.target.value })} />
            </Col >
            <Col style={{ display: "flex", width: '180px', flexDirection: "column", alignItems: "flex-start", gap: "10px" }}>
                <span style={clasess.headerStyle}>{t("customers.modal.password")}</span>
                <input style={clasess.inputStyle} placeholder="placeholder" type="text" value={user?.password} onChange={(e) => setUser({ ...user, password: e.target.value })} />
            </Col>
            ...
            <Col style={{ display: "flex", width: '180px', flexDirection: "column", alignItems: "flex-start", gap: "10px", marginBottom: "24px" }}>
                ...
                <input style={clasess.inputStyle} placeholder="placeholder" type="text" value={user?.userIPAddress} onChange={(e) => setUser({ ...user, userIPAddress: e.target.value })} />
            </Col>
