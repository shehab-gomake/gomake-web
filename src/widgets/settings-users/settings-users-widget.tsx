...
const SettingsUsersWidget = () => {
    ...
    const {handleAddEmployeeClick, openModal, setOpenModal, onUpdateEmployee, onAddEmployee, action} = useEmployee();
    return (
        <div>
            <div style={classes.tabsContainer}>
                <UsersSettingsTabs value={value} onChange={handleChange} aria-label="tabs example">
            ...
            <GoMakeModal
                ...
                modalTitle={t(action === EmployeeActions.ADD ? "usersSettings.addEmployee" : "usersSettings.editEmployee")}
            >
                <AddEmployee
