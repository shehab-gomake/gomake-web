const EditingIcon = (props: any) => {
    return (
      ...
      >
        <path
          d="M7.33203 1.33334H5.9987C2.66536 1.33334 1.33203 2.66668 1.33203 6.00001V10C1.33203 13.3333 2.66536 14.6667 5.9987 14.6667H9.9987C13.332 14.6667 14.6654 13.3333 14.6654 10V8.66668"
          stroke="#8283BE"
          stroke-width="1.5"
        ...
        />
        <path
          d="M9.94141 2.76666C10.3881 4.36 11.6347 5.60666 13.2347 6.06"
          stroke="#8283BE"
          stroke-width="1.5"
          stroke-miterlimit="10"
          stroke-linecap="round"
