...
const MoreMenuWidget = ({onClickDuplicate , onClickDelete }: IProps) => {
  const { classes } = useStyle();
  const { open, anchorEl, menuList, handleClose, handleClick } = useMoreCircle({onClickDuplicate , onClickDelete });
  return (
    <>
