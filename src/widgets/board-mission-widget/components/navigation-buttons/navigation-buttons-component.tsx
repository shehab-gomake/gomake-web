...
} from "@/widgets/board-mission-widget/hooks/use-board-missions-navigation-buttons";
import {styled} from "@mui/material/styles";
import {useGomakeTheme} from "@/hooks/use-gomake-thme";

const NavigationButtonsComponent = () => {
    const {boardMissionsViews, curView, handleViewChange} = useBoardMissionsNavigationButtons();
    return (
        <Stack>
            <ToggleButtonGroup value={curView}
                               exclusive
