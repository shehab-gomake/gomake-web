...
import { Avatar, IconButton, InputAdornment, MenuItem } from "@mui/material";
        ...
        <div style={clasess.container}>
            ...
            <GoMakeMenu handleClose={handleCloseNotify} open={openNotify} anchorEl={anchorNotifyEl}>
                <div style={clasess.mainMenuContainer}>
                    ...
                    <div style={clasess.accountTextStyle}>{t("Notifications")}</div>

                    <MenuItem style={{ width: "100%", minWidth: 200 }}>
                        <div style={clasess.manageAccountStyle}>
                            <div style={clasess.manageAccountTextStyle}>
                                {t("login.manageAccount")}
                            </div>
                    ...
                    <MenuItem style={clasess.logoutContainer}>
                        <ColoredCycle backgroundColor={"red"} ></ColoredCycle>
                        <div style={clasess.logoutContainer}>{t("login.logOut")}</div>
                    </MenuItem>
