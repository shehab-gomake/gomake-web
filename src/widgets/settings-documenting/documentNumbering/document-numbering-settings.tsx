            ...
            <div style={classes.header}>
                ...
                >
                    <Stack direction={'column'} gap={"20px"} padding={3}>
                        <Stack direction={'row'} gap={"19px"} >
                            {
                                editDocumentInputs(document).map(item => (
                                    <div ><FormInput input={item as IInput} changeState={onChangeInputs} error={false} readonly={!!item.readonly} />
                                        {showTooltip && item.name === "value" && (
                                            <Tooltip title={t("documentingSettings.nextValueTip") + " " + document.nextValue} arrow>
                        ...
                        <Stack direction={'row'} display={"Flex"} justifyContent={"flex-end"} paddingTop={6.5}>
