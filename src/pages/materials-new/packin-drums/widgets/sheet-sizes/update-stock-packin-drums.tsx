...
const UpdateStockPackinDrums = ({ categoryName, sizeId, stockValue }: any) => {
  ...
  const updateStock = useCallback(
    async (categoryName: string, sizeId: string) => {
      const updated = await callApi("POST", "/v1/packin-drums/update-stock", {
        categoryName,
        sizeId,
        stock: finalStock,
      });
