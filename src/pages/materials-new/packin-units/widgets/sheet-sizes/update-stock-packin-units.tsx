...
const UpdateStockPackinUnits = ({ categoryName, sizeId, stockValue }: any) => {
  ...
  const updateStock = useCallback(
    async (categoryName: string, sizeId: string) => {
      const updated = await callApi("POST", "/v1/packin-units/update-stock", {
        categoryName,
        sizeId,
        stock: finalStock,
      });
