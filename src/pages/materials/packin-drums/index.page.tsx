...
export default function Additions() {
  ...
  return (
    <CustomerAuthLayout>
      <HeaderTitle title={t("materials.packinDrums.title")} />
      <HeaderFilter
        setPackInDrumsSizes={setPackInDrumsSizes}
        onChangeSupplier={onChangeSupplier}
        onChangeCategory={onChangeCategory}
        packInDrumsCategories={packInDrumsCategories}
        categoryName={categoryName}
        packInDrumsSizes={packInDrumsSizes}
      />
      <div style={clasess.tableContainer}>
        <Table tableHeaders={tabelHeaders} tableRows={packInDrumsSizes} />
      </div>
    </CustomerAuthLayout>
  );
}
