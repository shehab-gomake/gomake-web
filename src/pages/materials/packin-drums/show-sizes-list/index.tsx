...
import { ShowSizesListWidgetForPackinDrums } from "./show-sizes-list-widget";
import { refetchMaterialDataState } from "@/store/refetch-material-data";
import { useRecoilValue } from "recoil";

const ShowSubTableForPackinDrums = ({ item }: any) => {
  ...
  const onClickGetFrameSizesInside = (item: any) => {
    ...
    setShowUnderRowWidget({
      stateShow: true,
      widget: <ShowSizesListWidgetForPackinDrums item={item} />,
      item,
      key: "code",
    });
  };
...
export { ShowSubTableForPackinDrums };
