...
const ShowSizesListWidgetForFrames = ({ item: _item }: any) => {
  const {
    headerTable,
    state,
    suppliers,
          ...
          tableRows={supplierData?.map((item: any) => {
            ...
            return {
                ...
                <>
                  {suppliers?.length > 0 && (
                    <GoMakeAutoComplate
                      ...
                      placeholder={t("materials.frames.selectSupplier")}
              ...
              price: (
                <GomakeTextInput
                  type="number"
                  placeholder={t("materials.frames.price")}
              ...
              currency: suppliersCurrencies?.length > 0 && (
                <GoMakeAutoComplate
                  ...
                  style={clasess.dropDownListContainer}
                  placeholder={t("materials.frames.selectCurrency")}
                  value={
...
export { ShowSizesListWidgetForFrames };
