...
const AddSupplierWidget = ({ item, suppliersData, setSuppliersData }: any) => {
  ...
  useEffect(() => {
    const arrayDisplay = [...item?.hardboardSuppliers];
    ...
    <div style={clasess.inputDataContainer}>
      <div style={clasess.rowItemStyle}>
        <GoMakeAutoComplate
          ...
          placeholder={t("materials.hardboards.supplierModal.selectSupplier")}
      ...
      <div style={clasess.rowItemStyle}>
        <GoMakeAutoComplate
          ...
          style={clasess.dropDownListContainer}
          placeholder={t("materials.hardboards.supplierModal.selectCurrency")}
