...
const ShowSizesListWidgetForPackinUnits = ({ item: _item }: any) => {
  const {
    headerTable,
    state,
    suppliers,
          ...
          tableRows={supplierData?.map((item: any) => {
            ...
            return {
                ...
                <>
                  {suppliers?.length > 0 && (
                    <GoMakeAutoComplate
                      ...
                      placeholder={t("materials.packinUnits.selectSupplier")}
              ...
              pricePerUnit: (
                <GomakeTextInput
                  type="number"
                  placeholder={t("materials.packinUnits.pricePerUnit")}
              ...
              currency: suppliersCurrencies?.length > 0 && (
                <GoMakeAutoComplate
                  ...
                  style={clasess.dropDownListContainer}
                  placeholder={t("materials.packinUnits.selectCurrency")}
                  value={
...
export { ShowSizesListWidgetForPackinUnits };
