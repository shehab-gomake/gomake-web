...
import { ShowSizesListWidgetForPackinUnits } from "./show-sizes-list-widget";
import { refetchMaterialDataState } from "@/store/refetch-material-data";
import { useRecoilValue } from "recoil";

const ShowSubTableForPackinUnits = ({ item }: any) => {
  ...
  const onClickGetFrameSizesInside = (item: any) => {
    ...
    setShowUnderRowWidget({
      stateShow: true,
      widget: <ShowSizesListWidgetForPackinUnits item={item} />,
      item,
      key: "code",
    });
  };
...
export { ShowSubTableForPackinUnits };
